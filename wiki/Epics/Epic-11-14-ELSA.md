...
**Status:** Mostly Complete (12-1..12-4 done; 12-5 partially complete; 12-6 + 12-7 planned) | **Stories:** 7 (12-1 through 12-7, plus 5 sub-stories under 12-7)

**Goal:** Add in-process tool execution loop to `CallLlmInlineActivity`, transforming single-turn LLM calls into multi-turn agentic sessions. Extended Wave-2 with 12-5 (prompt engineering framework — depends on Epic 27), 12-6 (tool executor enhancements), and 12-7 (LLM context tool access — 5 sub-stories 12-7a through 12-7e).
