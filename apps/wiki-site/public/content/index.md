...
- [Epic 6: Context & Knowledge Management](/epics/6-context-knowledge/) - Vector DB, RAG, MCP, cost monitoring, permissions, knowledge base
...
3. Check out [Epic 1](/epics/1-foundation/) to see foundational work
4. See [Epic 9](/epics/9-agent-management/) for the multi-agent system
