...
const WORKFLOW_DIAGRAMS: Record<string, WorkflowDef> = {
  ...
  'adl-orchestrator': {
    nodes: [
      ...
      n('done', 'Complete: Orchestrator Done', 0, 0, 'end'),
    ],
    edges: [
      e('start', 'config'),
      e('config', 'limits'),
  ...
  'single-issue-cycle': {
    nodes: [
      ...
      n('done', 'Complete: Issue Cycle Done', 280, 1970, 'end'),
      n('noIssues', 'Set Reason: No Issues', 530, 170, 'end'),
      n('planRejected', 'Set Reason: Plan Rejected', 530, 460, 'end'),
      n('error', 'Set Reason: Error', 530, 650, 'end'),
      n('tddFailed', 'Set Reason: TDD Failed', 530, 840, 'end'),
      n('ciFailed', 'Set Reason: CI Failed', 530, 1220, 'end'),
      n('reviewRejected', 'Set Reason: Review Rejected', 730, 1600, 'end'),
      n('mergeFailed', 'Set Reason: Merge Failed', 530, 1790, 'end'),
    ],
    edges: [
      e('start', 'select'),
      e('select', 'hasIssue'),
