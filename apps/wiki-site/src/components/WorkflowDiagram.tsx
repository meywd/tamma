...
const WORKFLOW_DIAGRAMS: Record<string, WorkflowDef> = {
  ...
  'adl-orchestrator': {
    nodes: [
      ...
      n('limits', 'Check Limits', 0, 0, 'process', { description: 'Active instances < max concurrent' }),
      ...
      n('exitNoIssues', 'Exit (No Issues)', 0, 0, 'end'),
      n('exitLimits', 'Exit (Limits)', 0, 0, 'end'),
    ],
    edges: [
      e('start', 'select'),
      e('select', 'selectOutcome'),
      e('selectOutcome', 'limits', 'Selected'),
      e('selectOutcome', 'exitNoIssues', 'NothingFound', 'right'),
