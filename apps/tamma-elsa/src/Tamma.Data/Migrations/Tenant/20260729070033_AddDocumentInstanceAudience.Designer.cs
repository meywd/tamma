...
namespace Tamma.Data.Migrations.Tenant
{
    ...
    [Migration("20260729070033_AddDocumentInstanceAudience")]
    partial class AddDocumentInstanceAudience
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tamma.Data.Entities.AcceptanceRulesOverride", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("UserId", "TenantId", "DocumentTypeKey")
                        .IsUnique()
                        .HasDatabaseName("IX_acceptance_rules_overrides_UserId_TenantId_DocumentTypeKey");

                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("UserId", "TenantId", "DocumentTypeKey"), false);

                    b.ToTable("acceptance_rules_overrides", null, t =>
                        {
                            t.HasCheckConstraint("ck_acceptance_rules_overrides_principal_xor", "(\"UserId\" IS NOT NULL AND \"TenantId\" IS NULL) OR (\"UserId\" IS NULL AND \"TenantId\" IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Tamma.Data.Entities.ChannelOutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "Audience", "Status")
                    ...
                    b.ToTable("channel_outbox", (string)null);
                });
            ...
            modelBuilder.Entity("Tamma.Data.Entities.DocumentInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("CorrelatingEventId")
                        .HasColumnType("uuid")
                        .HasColumnName("correlating_event_id");
                    ...
                    b.Property<string>("ProducedByAction")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("produced_by_action");

                    b.Property<string>("ProducedByRole")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("produced_by_role");

                    b.Property<string>("ProducedByWorkflow")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                        .HasColumnName("produced_by_workflow");
                    ...
                    b.HasIndex("IssueId", "DocumentType", "Status")
                        .HasDatabaseName("IX_document_instances_issue_type_status");

                    b.ToTable("document_instances", null, t =>
                        {
                            t.HasCheckConstraint("ck_document_instances_status", "status IN ('draft','validated','in_review','accepted','rejected','superseded','escalated')");
                        });
                });
            ...
            modelBuilder.Entity("Tamma.Data.Entities.IterationEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("iterations", null, t =>
                        {
                            t.HasCheckConstraint("ck_iterations_status", "\"Status\" IN ('planned','active','closed')");
                        });
                });

            modelBuilder.Entity("Tamma.Data.Entities.ProjectEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("EstimateScale")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)")
                        .HasDefaultValue("not_used");
                    ...
                    b.ToTable("projects", null, t =>
                        {
                            t.HasCheckConstraint("ck_projects_estimate_scale", "\"EstimateScale\" IN ('not_used','linear','fibonacci','exponential','t_shirt')");
            ...
            modelBuilder.Entity("Tamma.Data.Entities.TrackerPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("BoardGroupBy")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
                    ...
                    b.ToTable("tracker_preferences", null, t =>
                        {
                            t.HasCheckConstraint("ck_tracker_preferences_default_kind", "\"DefaultKind\" IS NULL OR \"DefaultKind\" IN ('epic','story','task','spike')");

                            t.HasCheckConstraint("ck_tracker_preferences_principal_xor", "(\"UserId\" IS NOT NULL AND \"TenantId\" IS NULL) OR (\"UserId\" IS NULL AND \"TenantId\" IS NOT NULL)");
                        });
                });

            modelBuilder.Entity("Tamma.Data.Entities.WorkItemEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ExternalRefJson")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<List<string>>("PreviousKeys")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text[]")
                    ...
                    b.HasIndex("PreviousKeys")
                        .HasDatabaseName("IX_work_items_previous_keys");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("PreviousKeys"), "gin");
                    ...
                    b.HasIndex("ProjectId", "ParentId", "SiblingRank")
                    ...
                    b.ToTable("work_items", null, t =>
                        {
                            t.HasCheckConstraint("ck_work_items_issue_type", "\"IssueType\" IS NULL OR \"IssueType\" IN ('bug','feature','chore','question','security','docs')");

                            t.HasCheckConstraint("ck_work_items_kind", "\"Kind\" IN ('epic','story','task','spike')");

                            t.HasCheckConstraint("ck_work_items_number", "\"Number\" >= 1");

                            t.HasCheckConstraint("ck_work_items_priority", "\"Priority\" IS NULL OR \"Priority\" IN ('urgent','high','normal','low')");

                            t.HasCheckConstraint("ck_work_items_status", "\"Status\" IN ('triage','backlog','ready','in_progress','in_review','blocked','done','cancelled')");
                        });
                });

            modelBuilder.Entity("Tamma.Data.Entities.WorkItemRelation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("work_item_relations", null, t =>
                        {
                            t.HasCheckConstraint("ck_work_item_relations_kind", "\"Kind\" IN ('blocks','duplicate','related')");

                            t.HasCheckConstraint("ck_work_item_relations_no_self", "\"SourceId\" <> \"TargetId\"");
                        });
                });
            ...
            modelBuilder.Entity("Tamma.Data.Entities.DocumentInstance", b =>
                {
                    b.HasOne("Tamma.Data.Entities.DocumentInstance", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Tamma.Data.Entities.IterationEntity", b =>
                {
                    b.HasOne("Tamma.Data.Entities.ProjectEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Tamma.Data.Entities.WorkItemEntity", b =>
                {
                    b.HasOne("Tamma.Data.Entities.IterationEntity", null)
                        .WithMany()
                        .HasForeignKey("IterationId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Tamma.Data.Entities.WorkItemEntity", null)
                        .WithMany()
