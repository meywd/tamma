...
public sealed class ComputeTenantRollupActivity : TammaAsyncActivity
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        // and it translates on both Postgres and the InMemory provider, so
        // unit tests and production share the same predicate. Only the
        // RUN_TRIGGERED terminal (one per dispatch) counts; RUN_POLLED /
        // RESULTS_COLLECTED are follow-up ops, not dispatches. Mirrors
        // ComputeTenantDimensionalRollupActivity.
