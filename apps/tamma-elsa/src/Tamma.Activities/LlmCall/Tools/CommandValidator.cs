...
public static class CommandValidator
{
    ...
    public static readonly (string Name, Regex Pattern)[] BlockedPatterns =
    {
        ...
        ("rm_rf_root", new Regex(@"\brm\s+(-rf\b|-fr\b).*\s/|\brm\b[^|;]*(-r\b|-R\b|--recursive\b)[^|;]*(-f\b|--force\b)[^|;]*/|\brm\b[^|;]*(-f\b|--force\b)[^|;]*(-r\b|-R\b|--recursive\b)[^|;]*/", RegexOptions.IgnoreCase | RegexOptions.Compiled)),
