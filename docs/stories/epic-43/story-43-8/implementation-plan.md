...
- **The allowlist enforces nothing until draining starts.** A seeded-with-everything ratchet is a snapshot, not a gate — except that the **count pin** makes any *new* ungoverned route fail immediately. That is the property that matters on day one; draining is separate work that no story schedules yet (epic open question 5).
