 ...
 *
 * Placeholder implementation for Weaviate vector database. The constructor
...
const WEAVIATE_STUB_MESSAGE =
  'Weaviate provider is a stub; only chromadb and pgvector are production-ready in this Tamma version. Configure VECTOR_STORE_PROVIDER=chromadb or pgvector as a fallback.';
...
export class WeaviateVectorStore extends BaseVectorStore {
  constructor(config: VectorStoreConfig) {
    ...
    throw new ProviderNotImplementedError('weaviate', undefined, {
      context: { message: WEAVIATE_STUB_MESSAGE },
    });
  }
