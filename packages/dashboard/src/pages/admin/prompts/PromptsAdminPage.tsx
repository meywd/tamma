...
export function PromptsAdminPage(): JSX.Element {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-gray-900 mb-1">System Prompts</h1>
      ...
      {loading && data === null ? (
        ...
        <div className="bg-red-50 border border-red-200 rounded-md p-4 text-sm text-red-700">
          ...
          <button
            type="button"
            onClick={() => void reload()}
            className="px-3 py-1.5 text-xs font-medium text-red-700 border border-red-300 bg-white rounded-md hover:bg-red-100"
          >
            Retry
          </button>
        </div>
