...
export function OrganizationLayout(): JSX.Element {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-gray-900 mb-1 dark:text-gray-100">{tenantName}</h1>
      <p className="text-sm text-gray-500 mb-6 dark:text-gray-400">Manage members, invites, and audit log.</p>
