          ...
          return (
            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                {tmpl && (
                  <div className="flex items-center gap-2 text-xs text-gray-500 font-mono dark:text-gray-400">
              ...
              {tmpl ? (
                <pre className="text-xs font-mono leading-relaxed whitespace-pre-wrap break-words text-gray-700 bg-gray-50 border border-gray-100 rounded-md px-3 py-2 max-h-48 overflow-y-auto dark:bg-gray-900 dark:text-gray-300 dark:border-gray-800">
                  {tmpl.template}
                </pre>
              ) : (
